...
def mint_ticket(
    *, user_id: str, provider: str, session_key: str = "",
    org_id: str = "", access_token: str = "",
) -> str:
    ...
    info = {
        ...
        "org_id": org_id,
        # This stays only in the process-local, 30-second ticket store.  It is
        # needed to revalidate the browser session immediately before accept.
